...
output_name="gemini_2_5_output_universal"
...
python 1_pipeline_universal_two_stage.py \
  ...
  --output="../demo_output/${output_name}_${prompt_version}.json" \
...
python 2_json_reformat_two_stage.py \
  --input-json="../demo_output/${output_name}_${prompt_version}.json" \
  --output-json="../demo_output/${output_name}_${prompt_version}_reformat.json"
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${CYAN}  - ../demo_output/${output_name}_${prompt_version}.json (Raw results)${NC}"
    echo -e "${CYAN}  - ../demo_output/${output_name}_${prompt_version}_reformat.json (Formatted results)${NC}"
